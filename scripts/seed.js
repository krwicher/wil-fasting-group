  ...
  const fasts = [
    {
      ...
      description: 'Join us for a 48-hour fast starting Friday evening. Let\'s support each other through the weekend!',
    ...
    },
    {
      ...
      description: 'A longer fast for experienced fasters. We start Monday morning and break Thursday morning.',
      creator_id: creatorId,
    ...
    },
    {
      ...
      description: 'Our monthly extended fast. This is for committed fasters ready to go the distance.',
      creator_id: creatorId,
...
async function main() {
  ...
  try {
    ...
    if (ADMIN_EMAIL) {
      ...
      console.log('Set ADMIN_EMAIL environment variable to promote a user to super_admin')
      return
    }
